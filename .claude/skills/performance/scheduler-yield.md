...
version: 1.0.0
description: This document explains the `scheduler.yield()` API implementation for Chromium 2025 (Chrome 129+) to improve INP (Intera
author: Claude Code
created: 2026-01-25
updated: 2026-01-25
...
# Migration metadata
migrated_from: projects/dmb-almanac/app/docs/analysis/scheduler/SCHEDULER_YIELD_GUIDE.md

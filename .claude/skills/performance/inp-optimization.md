...
version: 1.0.0
description: This guide documents how to use `scheduler.yield()` and related utilities to optimize Interaction to Next Paint (INP) pe
author: Claude Code
created: 2026-01-25
updated: 2026-01-25
...
# Migration metadata
migrated_from: projects/dmb-almanac/app/src/lib/utils/INP_OPTIMIZATION_GUIDE.md

...
name: quick-start
version: 1.0.0
description: The "Install App" button on the home page now works and triggers the native PWA install prompt when clicked.
author: Claude Code
created: 2026-01-25
updated: 2026-01-25
...
# Migration metadata
migrated_from: projects/dmb-almanac/app/docs/archive/misc/QUICK_START_GUIDE.md

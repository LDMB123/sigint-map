---
name: query-helpers-refactoring
version: 1.0.0
description: The new `query-helpers.ts` file provides reusable utilities to reduce duplication in `queries.ts` by approximately **25-
author: Claude Code
created: 2026-01-25
updated: 2026-01-25
...
# Migration metadata
migrated_from: projects/dmb-almanac/app/src/lib/db/dexie/QUERY_HELPERS_REFACTORING_GUIDE.md

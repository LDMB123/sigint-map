...
```bash
# Check Python (needed for recommended method)
python3 --version
...
# a. Get your Mac IP: ipconfig getifaddr en0
# b. Visit http://<IP>:8080 on iPad
# c. Share > Add to Home Screen
# d. Verify icon appears correctly
```

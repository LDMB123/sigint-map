...
- Archive Path: `docs/archive/phase-docs/STATUS_LEDGER.md`
- Normalized On: `2026-03-04`
- Source Title: `Status Ledger`
...
`../reports/status-ledger-history-2026-02-13-to-2026-02-14.md`.
...
| 2026-02-15 | Moved root screenshot artifacts to `../assets/root-screenshots` | Completed |

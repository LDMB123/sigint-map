...
- Archive Path: `docs/archive/phase-docs/BUG_TRACKING.md`
- Normalized On: `2026-03-04`
- Source Title: `Bug Tracking - Issue Registry`
...
- `../DETAILED_BUG_FIXES_COMPLETE.md`
- `../DETAILED_CONSOLIDATED_FIXES.md`
- `../DETAILED_CRITICAL_FIXES.md`
- `../DETAILED_FIXES_CHECKLIST.md`
- `../DETAILED_GAME_DEBUG.md`
- `../DETAILED_GARDENS_BUGS.md`
- `../DETAILED_KNOWN_BUGS.md`

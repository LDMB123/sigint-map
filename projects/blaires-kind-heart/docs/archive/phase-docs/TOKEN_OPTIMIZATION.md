...
- Archive Path: `docs/archive/phase-docs/TOKEN_OPTIMIZATION.md`
- Normalized On: `2026-03-04`
- Source Title: `Token Optimization Plan`
...
4. Moved non-runtime root screenshots to `../assets/root-screenshots`.

### Optimization Status
1. High-size active docs were compressed to summary + archive pattern:
   - `docs/EMOTION_SYSTEM.md` -> full copy in `../reference-full/EMOTION_SYSTEM.full.md`
   - `docs/ICONS.md` -> full copy in `../reference-full/ICONS.full.md`
   - `docs/TESTING.md` -> full copy in `../reference-full/TESTING.full.md`
   - `docs/TROUBLESHOOTING.md` -> full copy in `../reference-full/TROUBLESHOOTING.full.md`

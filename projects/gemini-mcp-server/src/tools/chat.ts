...
export function registerChatTools(
  ...
  server.tool(
    "chat_create",
    "Create a new multi-turn chat session with Gemini. Returns a session ID for subsequent messages.",
    {
      sessionId: z
        .string()
  ...
  server.tool(
    "chat_send",
    "Send a message in an existing chat session and get a response. Maintains conversation history.",
    {

...
export function registerEmbedTextTool(server, client) {
    server.tool("embed_text", "Generate text embeddings using Gemini embedding models. Useful for semantic search, clustering, and similarity comparisons.", {
        texts: z

...
#[cfg(feature = "hydrate")]
pub fn navigator_platform() -> Option<String> {
    normalize_non_empty(navigator_property_or_undefined("platform").as_string())
}
...
#[cfg(feature = "hydrate")]
pub fn navigator_user_agent() -> Option<String> {
    normalize_non_empty(navigator_property_or_undefined("userAgent").as_string())
}

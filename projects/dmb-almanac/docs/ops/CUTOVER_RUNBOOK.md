...
- Offline import/bootstrap completion
- IDB repair flow and parity report export
- SW update flow and update-loop resistance (multi-deploy test)
It does NOT currently gate on AI diagnostics/degradation coverage; run those separately when touching AI runtime behavior.

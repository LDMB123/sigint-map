...
/**
 * V23 APEX - Two-pass, multi-turn refinement for max photorealism
 *
...
const OUTPUT_DIR = process.env.OUTPUT_DIR || path.join(process.env.HOME, 'nanobanana-output', 'vegas-v23-apex');
...
const SCENE_BASE = `EVENT-DRIVEN SPEAKEASY SETTING (FIRST PRINCIPLES): Hidden high-fashion Vegas speakeasy accessed through a vault door and velvet drapes. Intimate private bar with Art Deco brass + onyx palette; black marble bar with mirrored underlip; smoked mirror ceiling; brass lattice truss; LED bottle wall; real neon signage; suspended candle cylinders; shallow water channel behind bar generating caustic flicker; wet stone entry with gritty rubber mat; EXIT sign and sprinkler heads; bar mats, speed rail, garnish station, POS glow; ice bins and backbar shadows; VIP rope stanchions; low haze.`;
...
function validatePrompt(prompt, label) {
  ...
  if (!lower.includes('34-36cm') && !lower.includes('34cm')) {
    console.log(`WARN: ${label} missing explicit hemline 34-36cm anchor.`);
  }
...
const concepts = [
  {
    name: '231-electrowetting-cascade-open-sides',
    scene: 'VIP rope stanchions and a discreet security post near the entry, soft reflections on wet stone floor.',
    geometry: 'Black satin microdress with a halter collar and a narrow center keyhole to the sternum, fully open back to the waist, and extreme side cutouts bridged by micro-chain links at the ribcage and hip. Ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '232-magnetoelastic-rib-cage',
    scene: 'Back-bar POS terminal glow and receipt printer spill a faint cool edge light.',
    geometry: 'Sculpted microdress with open back to the waist and vertical side cutouts up to the ribcage; narrow underbust aperture and low square neckline at the upper bust line with a slim center keyhole and sheer mesh backing. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '233-acousto-optic-fringe-halter',
    scene: 'Ice bucket condensation and crystal coupe reflections add tiny specular points on the bar.',
    geometry: 'Halter microdress with a fully open back and high side cutouts; crystal fringe at hemline and an ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '234-liquid-crystal-elastomer-slit',
    scene: 'Smoked mirror ceiling doubles candle cylinders into repeating rows.',
    geometry: 'One-shoulder microdress with a diagonal front slit and open back to the waist; narrow side cutout and low angled neckline at the upper bust line with a narrow center keyhole and sheer mesh backing. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '235-photonic-microprism-harness',
    scene: 'Neon signage creates soft color spill across booths and the bar edge.',
    geometry: 'Microdress with low open back and open sides bridged by a thin harness over the midriff; ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '236-thermochromic-iris-cutout',
    scene: 'Water-channel caustics flicker across the bar lip and lower wall.',
    geometry: 'Strapless microdress with large side cutouts and open back to the waist; straight neckline just below collarbones with a slim center keyhole to the sternum, backed by sheer mesh. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '237-graphene-lace-suspension',
    scene: 'Brass lattice truss casts geometric shadow bands across the booths.',
    geometry: 'Lace microdress with thin straps, open back to the waist, and high side cutouts; ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '238-quantum-dot-veil-bridges',
    scene: 'Neon spill paints soft color on the smoked mirror ceiling.',
    geometry: 'Black satin microdress with open sides linked by micro-chain bridges; low open back; ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '239-plasmonic-foil-tension',
    scene: 'Amber liquor wall glows behind the bar, reflecting in black marble.',
    geometry: 'Metallic foil microdress with a narrow underbust cutout and open back to the waist; low square neckline at the upper bust line with a slim center keyhole and sheer mesh backing. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '240-auxetic-microgrid-expose',
    scene: 'LED bottle wall adds faint cool fill to the scene.',
    geometry: 'Microdress with open back to the waist and an auxetic microgrid midriff cage; high-cut sides and ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '241-electrochromic-lamella-spine',
    scene: 'Blue-violet spill grazes the smoked mirror ceiling.',
    geometry: 'Panelled microdress with low open back; lamella side panels and a narrow spine opening; straight neckline just below collarbones with a slim center keyhole to the sternum, backed by sheer mesh. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '242-hydrogel-microlens-sheers',
    scene: 'Candle cylinders produce warm pools with deep shadow falloff.',
    geometry: 'Sheer-panel microdress with open back to the waist and narrow side cutouts; ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '243-viscoelastic-crystal-cowl',
    scene: 'Low haze diffuses neon into soft bokeh.',
    geometry: 'Microdress with dramatic cowl back and open sides linked by fine straps; ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '244-phase-change-banded-satin',
    scene: 'Glass reflections ripple across the bar surface.',
    geometry: 'Satin microdress with open back to the waist and asymmetric side cutout; low square neckline at the upper bust line with a slim center keyhole and sheer mesh backing. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '245-microled-fiber-backchain',
    scene: 'Smoked mirror ceiling reflects the candle cylinders into a grid.',
    geometry: 'Microdress with low open back and thin straps; open sides linked by a micro-LED fiber chain; ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '246-photoelastic-strap-corset',
    scene: 'Neon sign reflection smears along the polished bar edge.',
    geometry: 'Corset microdress with open back to the waist; transparent strap harness across the midriff; straight neckline just below collarbones with a slim center keyhole to the sternum, backed by sheer mesh. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '247-superhydrophobic-slit-silk',
    scene: 'Amber bottle wall glow reflects in the bar’s black marble surface.',
    geometry: 'Silk microdress with diagonal front slit and open back to the waist; thin straps; ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '248-metaweave-interference',
    scene: 'Brass lattice truss creates repeating shadow grids across the bar.',
    geometry: 'Microdress with open back to the waist and high side cutouts; narrow underbust aperture and low square neckline at the upper bust line with a slim center keyhole and sheer mesh backing. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '249-tribo-mechano-chain',
    scene: 'LED bottle wall flickers subtly, adding cool fill.',
    geometry: 'Microdress with open sides bridged by chain links; open back to the waist; ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the sternum for support. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '250-acousto-optic-iris-drape',
    scene: 'Kinetic brass iris overhead throws moving specular highlights across the room.',
    geometry: 'One-shoulder microdress with open back to the waist and a narrow side cutout; soft drape at the hip; low angled neckline at the upper bust line with a narrow center keyhole and sheer mesh backing. Upper-thigh hemline 34-36cm.',
...
console.log(`\n=== V23 APEX - Two-pass, multi-turn refinement ===`);

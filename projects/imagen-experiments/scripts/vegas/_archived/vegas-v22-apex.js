...
/**
 * V22 APEX - Two-pass, multi-turn refinement for max photorealism
 *
...
const OUTPUT_DIR = process.env.OUTPUT_DIR || path.join(process.env.HOME, 'nanobanana-output', 'vegas-v22-apex');
...
const concepts = [
  {
    name: '211-electrowetting-cascade-open-sides',
    scene: 'VIP rope stanchions and a discreet security post near the entry, soft reflections on wet stone floor.',
    geometry: 'Black satin microdress with a high halter neckline, fully open back to the waist, and extreme side cutouts bridged by micro-chain links at the ribcage and hip. Low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with gunmetal welt. 3-denier T=0.98.',
  },
  {
    name: '212-magnetoelastic-rib-cage',
    scene: 'Back-bar POS terminal glow and receipt printer spill a faint cool edge light.',
    geometry: 'Sculpted microdress with open back to the waist and vertical side cutouts up to the ribcage; narrow underbust aperture and low square neckline at upper bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with graphite welt. 3-denier T=0.98.',
  },
  {
    name: '213-acousto-optic-fringe-halter',
    scene: 'Ice bucket condensation and crystal coupe reflections add tiny specular points on the bar.',
    geometry: 'Halter microdress with a fully open back and high side cutouts; crystal fringe at hemline and a low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with crystal welt. 3-denier T=0.98.',
  },
  {
    name: '214-liquid-crystal-elastomer-slit',
    scene: 'Smoked mirror ceiling doubles candle cylinders into repeating rows.',
    geometry: 'One-shoulder microdress with a diagonal front slit and open back to the waist; narrow side cutout and low angled neckline to upper bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with sapphire welt. 3-denier T=0.98.',
  },
  {
    name: '215-photonic-microprism-harness',
    scene: 'Neon signage creates soft color spill across booths and the bar edge.',
    geometry: 'Microdress with low open back and open sides bridged by a thin harness over the midriff; low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with metallic welt. 3-denier T=0.98.',
  },
  {
    name: '216-thermochromic-iris-cutout',
    scene: 'Water-channel caustics flicker across the bar lip and lower wall.',
    geometry: 'Strapless microdress with large side cutouts and open back to the waist; low straight neckline just below collarbones. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with burgundy welt. 3-denier T=0.98.',
  },
  {
    name: '217-graphene-lace-suspension',
    scene: 'Brass lattice truss casts geometric shadow bands across the booths.',
    geometry: 'Lace microdress with thin straps, open back to the waist, and high side cutouts; low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with matte welt. 3-denier T=0.98.',
  },
  {
    name: '218-quantum-dot-veil-bridges',
    scene: 'Neon spill paints soft color on the smoked mirror ceiling.',
    geometry: 'Black satin microdress with open sides linked by micro-chain bridges; low open back; low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with crimson welt. 3-denier T=0.98.',
  },
  {
    name: '219-plasmonic-foil-tension',
    scene: 'Amber liquor wall glows behind the bar, reflecting in black marble.',
    geometry: 'Metallic foil microdress with a narrow underbust cutout and open back to the waist; low square neckline to upper bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with gold welt. 3-denier T=0.98.',
  },
  {
    name: '220-auxetic-microgrid-expose',
    scene: 'LED bottle wall adds faint cool fill to the scene.',
    geometry: 'Microdress with open back to the waist and an auxetic microgrid midriff cage; high-cut sides and low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '221-electrochromic-lamella-spine',
    scene: 'Blue-violet spill grazes the smoked mirror ceiling.',
    geometry: 'Panelled microdress with low open back; lamella side panels and a narrow spine opening; low straight neckline below collarbones. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with cobalt welt. 3-denier T=0.98.',
  },
  {
    name: '222-hydrogel-microlens-sheers',
    scene: 'Candle cylinders produce warm pools with deep shadow falloff.',
    geometry: 'Sheer-panel microdress with open back to the waist and narrow side cutouts; low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Nude thigh-high stockings with pearl welt. 3-denier T=0.98.',
  },
  {
    name: '223-viscoelastic-crystal-cowl',
    scene: 'Low haze diffuses neon into soft bokeh.',
    geometry: 'Microdress with dramatic cowl back and open sides linked by fine straps; low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with prism welt. 3-denier T=0.98.',
  },
  {
    name: '224-phase-change-banded-satin',
    scene: 'Glass reflections ripple across the bar surface.',
    geometry: 'Satin microdress with open back to the waist and asymmetric side cutout; low square neckline to upper bust line with full coverage. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '225-microled-fiber-backchain',
    scene: 'Smoked mirror ceiling reflects the candle cylinders into a grid.',
    geometry: 'Microdress with low open back and thin straps; open sides linked by a micro-LED fiber chain; low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with electric-blue welt. 3-denier T=0.98.',
  },
  {
    name: '226-photoelastic-strap-corset',
    scene: 'Neon sign reflection smears along the polished bar edge.',
    geometry: 'Corset microdress with open back to the waist; transparent strap harness across the midriff; low straight neckline below collarbones. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '227-superhydrophobic-slit-silk',
    scene: 'Amber bottle wall glow reflects in the bar’s black marble surface.',
    geometry: 'Silk microdress with diagonal front slit and open back to the waist; thin straps; low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with satin welt. 3-denier T=0.98.',
  },
  {
    name: '228-metaweave-interference',
    scene: 'Brass lattice truss creates repeating shadow grids across the bar.',
    geometry: 'Microdress with open back to the waist and high side cutouts; narrow underbust aperture and low square neckline to upper bust line with full coverage. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '229-tribo-mechano-chain',
    scene: 'LED bottle wall flickers subtly, adding cool fill.',
    geometry: 'Microdress with open sides bridged by chain links; open back to the waist; low scoop neckline ending just above the bust line with full coverage. Upper-thigh hemline 34-36cm.',
  ...
  {
    name: '230-acousto-optic-iris-drape',
    scene: 'Kinetic brass iris overhead throws moving specular highlights across the room.',
    geometry: 'One-shoulder microdress with open back to the waist and a narrow side cutout; soft drape at the hip; low angled neckline to upper bust line with full coverage. Upper-thigh hemline 34-36cm.',
...
console.log(`\n=== V22 APEX - Two-pass, multi-turn refinement ===`);
...
for (let i = s; i < Math.min(e, concepts.length); i++) {
  const conceptNum = i + 211;
  if (existingNums.has(conceptNum)) {
    console.log(`SKIP [${conceptNum}/230] ${concepts[i].name} (already exists)`);

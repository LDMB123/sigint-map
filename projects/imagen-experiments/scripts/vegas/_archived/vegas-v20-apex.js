...
/**
 * V20 APEX - Two-pass, multi-turn refinement for max photorealism
 *
...
const OUTPUT_DIR = process.env.OUTPUT_DIR || path.join(process.env.HOME, 'nanobanana-output', 'vegas-v20-apex');
...
function validatePrompt(prompt, label) {
  ...
  if (!lower.includes('38-40cm') && !lower.includes('38cm')) {
    console.log(`WARN: ${label} missing explicit hemline 38-40cm anchor.`);
  }
...
const concepts = [
  {
    name: '171-electrowetting-cascade-open-sides',
    scene: 'Kinetic brass iris sculpture above the bar rotates slowly, throwing moving highlights.',
    geometry: 'Black satin microdress with a high halter neckline, fully open back to the waist, and extreme side cutouts bridged by micro-chain links at the ribcage and hip. Low scoop front neckline ending at mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with gunmetal welt. 6-denier T=0.94.',
  },
  {
    name: '172-magnetoelastic-rib-cage',
    scene: 'Neon sign reflections ripple across the black marble bar top.',
    geometry: 'Sculpted microdress with open back to the waist and vertical side cutouts up to the ribcage; narrow underbust aperture and low square neckline at mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with graphite welt. 6-denier T=0.94.',
  },
  {
    name: '173-acousto-optic-fringe-halter',
    scene: 'Low haze carries thin beams from the LED bottle wall into the booths.',
    geometry: 'Halter microdress with a fully open back and high side cutouts; crystal fringe at hemline and a low scoop front neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with crystal welt. 6-denier T=0.94.',
  },
  {
    name: '174-liquid-crystal-elastomer-slit',
    scene: 'Smoked mirror ceiling doubles candle cylinders into repeating rows.',
    geometry: 'One-shoulder microdress with a diagonal front slit and open back to the waist; narrow side cutout and low angled neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with sapphire welt. 6-denier T=0.94.',
  },
  {
    name: '175-photonic-microprism-harness',
    scene: 'Neon signage creates soft color spill across the booths.',
    geometry: 'Microdress with low open back and open sides bridged by a thin harness over the midriff; low scoop front neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with metallic welt. 6-denier T=0.94.',
  },
  {
    name: '176-thermochromic-iris-cutout',
    scene: 'Water-channel caustics flicker across the bar lip and lower wall.',
    geometry: 'Strapless microdress with large side cutouts and open back to the waist; low straight neckline just below collarbones. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with burgundy welt. 6-denier T=0.94.',
  },
  {
    name: '177-graphene-lace-suspension',
    scene: 'Brass lattice truss casts geometric shadow bands across the booths.',
    geometry: 'Lace microdress with thin straps, open back to the waist, and high side cutouts; low scoop neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with matte welt. 6-denier T=0.94.',
  },
  {
    name: '178-quantum-dot-veil-bridges',
    scene: 'Neon spill paints soft color on the smoked mirror ceiling.',
    geometry: 'Black satin microdress with open sides linked by micro-chain bridges; low open back; low scoop neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with crimson welt. 6-denier T=0.94.',
  },
  {
    name: '179-plasmonic-foil-tension',
    scene: 'Amber liquor wall glows behind the bar, reflecting in black marble.',
    geometry: 'Metallic foil microdress with a narrow underbust cutout and open back to the waist; low square neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with gold welt. 6-denier T=0.94.',
  },
  {
    name: '180-auxetic-microgrid-expose',
    scene: 'LED bottle wall adds faint cool fill to the scene.',
    geometry: 'Microdress with open back to the waist and an auxetic microgrid midriff cage; high-cut sides and low scoop neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
  ...
  {
    name: '181-electrochromic-lamella-spine',
    scene: 'Blue-violet spill grazes the smoked mirror ceiling.',
    geometry: 'Panelled microdress with low open back; lamella side panels and a narrow spine opening; low straight neckline below collarbones. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with cobalt welt. 6-denier T=0.94.',
  },
  {
    name: '182-hydrogel-microlens-sheers',
    scene: 'Candle cylinders produce warm pools with deep shadow falloff.',
    geometry: 'Sheer-panel microdress with open back to the waist and narrow side cutouts; low scoop neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Nude thigh-high stockings with pearl welt. 6-denier T=0.94.',
  },
  {
    name: '183-viscoelastic-crystal-cowl',
    scene: 'Low haze diffuses neon into soft bokeh.',
    geometry: 'Microdress with dramatic cowl back and open sides linked by fine straps; low scoop neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with prism welt. 6-denier T=0.94.',
  },
  {
    name: '184-phase-change-banded-satin',
    scene: 'Glass reflections ripple across the bar surface.',
    geometry: 'Satin microdress with open back to the waist and asymmetric side cutout; low square neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
  ...
  {
    name: '185-microled-fiber-backchain',
    scene: 'Smoked mirror ceiling reflects the candle cylinders into a grid.',
    geometry: 'Microdress with low open back and thin straps; open sides linked by a micro-LED fiber chain; low scoop neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with electric-blue welt. 6-denier T=0.94.',
  },
  {
    name: '186-photoelastic-strap-corset',
    scene: 'Neon sign reflection smears along the polished bar edge.',
    geometry: 'Corset microdress with open back to the waist; transparent strap harness across the midriff; low straight neckline below collarbones. Upper-thigh hemline 38-40cm.',
  ...
  {
    name: '187-superhydrophobic-slit-silk',
    scene: 'Amber bottle wall glow reflects in the bar’s black marble surface.',
    geometry: 'Silk microdress with diagonal front slit and open back to the waist; thin straps; low scoop neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
    ...
    hosiery: 'HOSIERY: Black thigh-high stockings with satin welt. 6-denier T=0.94.',
  },
  {
    name: '188-metaweave-interference',
    scene: 'Brass lattice truss creates repeating shadow grids across the bar.',
    geometry: 'Microdress with open back to the waist and high side cutouts; narrow underbust aperture and low square neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
  ...
  {
    name: '189-tribo-mechano-chain',
    scene: 'LED bottle wall flickers subtly, adding cool fill.',
    geometry: 'Microdress with open sides bridged by chain links; open back to the waist; low scoop neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
  ...
  {
    name: '190-acousto-optic-iris-drape',
    scene: 'Kinetic brass iris overhead throws moving specular highlights across the room.',
    geometry: 'One-shoulder microdress with open back to the waist and a narrow side cutout; soft drape at the hip; low angled neckline to mid-sternum. Upper-thigh hemline 38-40cm.',
...
console.log(`\n=== V20 APEX - Two-pass, multi-turn refinement ===`);
...
for (let i = s; i < Math.min(e, concepts.length); i++) {
  const conceptNum = i + 171;
  if (existingNums.has(conceptNum)) {
    console.log(`SKIP [${conceptNum}/190] ${concepts[i].name} (already exists)`);

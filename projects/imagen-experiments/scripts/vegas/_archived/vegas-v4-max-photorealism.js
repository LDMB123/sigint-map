...
const OUTPUT_DIR = '/Users/louisherman/nanobanana-output/vegas-max-attractive';
...
const concepts = Array.from({length: 30}, (_, i) => {
  ...
  return {
    name: `Vegas-MaxAttract-${String(i+1).padStart(2, '0')}`,
...
async function main() {
  ...
  console.log('VEGAS MAXIMUM ATTRACTIVENESS: 30 Concepts');
  console.log('='.repeat(80));

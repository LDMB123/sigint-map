...
/**
 * V25 APEX - Two-pass, multi-turn refinement for max photorealism
 *
...
const OUTPUT_DIR = process.env.OUTPUT_DIR || path.join(process.env.HOME, 'nanobanana-output', 'vegas-v25-apex');
...
console.log(`\n=== V25 APEX - Two-pass, multi-turn refinement ===`);

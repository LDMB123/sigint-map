...
/**
 * V26 APEX - Two-pass, multi-turn refinement for max photorealism
 *
...
const OUTPUT_DIR = process.env.OUTPUT_DIR || path.join(process.env.HOME, 'nanobanana-output', 'vegas-v26-apex');
...
const concepts = [
  {
    name: '291-ferrofluid-capillary-bridges',
    scene: 'Backlit liquor wall and mirrored columns with CityCenter lights beyond the glass.',
    geometry: 'Black satin microdress with a halter collar and an elongated center keyhole to the upper abdomen, fully open back to the waist, and extreme side cutouts bridged by micro-chain links at the ribcage and hip. Ultra-low scoop neckline stopping just above the bust line; a narrow sheer illusion insert drops to the upper abdomen for support. Upper-thigh hemline 30-32cm.',
    material: 'Satin base with ferrofluid capillary channels along the chain bridges.',
    materialFallback: 'Satin base with glossy dark liquid beads along chain bridges.',
    micro: 'FERROFLUID CAPILLARIES: magnetic alignment forms bead chains with sharp specular dots and subtle meniscus shadows; beads cluster near field peaks with thin trailing films.',
    microFallback: 'Dark liquid beads form chains with small specular dots and meniscus shadows.',
    hosiery: 'HOSIERY: Black thigh-high stockings with midnight welt. 2-denier T=0.99 with silicone stay-up band.',
  },
  {
    name: '292-shear-thickening-veil-slit',
    scene: 'Geometric ceiling light grid and bronze foot rail reflections across the marble bar.',
    geometry: 'Strap microdress with diagonal front slit, open back to the waist, and high side cutouts; low square neckline with an elongated center keyhole to the upper abdomen and sheer mesh backing. Upper-thigh hemline 30-32cm.',
    material: 'Sheer veil overlay infused with shear-thickening microgels.',
    materialFallback: 'Sheer overlay that tightens into crisp pleats under tension.',
    micro: 'STF VEIL: high strain stiffens the overlay into crisp micro-pleats and sharp highlight ridges; relaxed zones drape with soft diffuse sheen.',
    microFallback: 'Overlay tightens into crisp pleats at tension points; soft drape elsewhere.',
    hosiery: 'HOSIERY: Black thigh-high stockings with graphite welt. 2-denier T=0.99 with silicone stay-up band.',
  },
  {
    name: '293-electroactive-polymer-straplines',
    scene: 'Sculptural pendants and plush banquette glow behind the bar.',
    geometry: 'Microdress with low open back and open sides bridged by thin straplines over the midriff; ultra-low scoop neckline stopping just above the bust line with a narrow sheer illusion insert to the upper abdomen. Upper-thigh hemline 30-32cm.',
    material: 'Matte base with electroactive polymer straplines.',
    materialFallback: 'Matte base with taut straplines and clean edge highlights.',
    micro: 'EAP STRAPLINES: micro-contractions create subtle tension waves; strap surfaces show tight specular ridges and tiny compression marks at anchor points.',
    microFallback: 'Straps look taut with fine tension ridges and crisp edge highlights.',
    hosiery: 'HOSIERY: Black thigh-high stockings with steel welt. 2-denier T=0.99 with silicone stay-up band.',
  },
  {
    name: '294-piezoelectric-microfringe',
    scene: 'Candle clusters on the bar with neon reflections across the marble.',
    geometry: 'Halter microdress with open back to the waist and high side cutouts; ultra-low scoop neckline with a narrow sheer illusion insert; hemline 30-32cm with microfringe.',
    material: 'Matte base with piezoelectric microfringe.',
    materialFallback: 'Matte base with fringe that sparkles on motion.',
    micro: 'PIEZOFIBER FRINGE: flexing fibers emit faint glints; collisions create tiny sparkle bursts and micro-caustic dots on skin; motion lag visible.',
    microFallback: 'Fringe sparkles on motion with small delayed swing and tiny caustic dots.',
    hosiery: 'HOSIERY: Black thigh-high stockings with crystal welt. 2-denier T=0.99 with silicone stay-up band.',
  },
  {
    name: '295-photonic-quasicrystal-lace',
    scene: 'Backlit liquor wall and mirrored columns with soft neon spill.',
    ...
    material: 'Photonic quasicrystal lace overlay on a satin base.',
  ...
  {
    name: '296-liquid-metal-capillary-spine',
    scene: 'Long curved marble counter and bronze foot rail glow.',
    geometry: 'Microdress with a narrow spine opening, open back to the waist, and side cutouts; straight neckline just below collarbones with an elongated center keyhole to the upper abdomen, backed by sheer mesh. Upper-thigh hemline 30-32cm.',
    material: 'Liquid-metal capillary tubes along the spine and seams.',
    materialFallback: 'Thin metallic tubes with mirror glints along the spine.',
    micro: 'LIQUID-METAL CAPILLARIES: smooth mirror glints, meniscus curvature at junctions, and slight oxidation haze at edges.',
    microFallback: 'Mirror glints on thin tubes with subtle meniscus curvature.',
    hosiery: 'HOSIERY: Black thigh-high stockings with chrome welt. 2-denier T=0.99 with silicone stay-up band.',
  },
  {
    name: '297-magnetorheological-gel-panels',
    scene: 'Floor-to-ceiling windows with CityCenter night lights.',
    ...
    material: 'Magnetorheological gel panels over a satin base.',
    materialFallback: 'Semi-gloss gel panels over satin with tight highlights.',
    micro: 'MR GEL: field stiffens panels into smooth convex bulges; low field zones sag slightly; glossy highlights tighten on stiffened zones.',
  ...
  {
    name: '298-auxetic-origami-windows',
    scene: 'Geometric ceiling lights and mirrored columns framing the bar.',
    geometry: 'Microdress with a wide underbust aperture, open back to the waist, and high side cutouts; ultra-low scoop neckline with a narrow sheer illusion insert to the upper abdomen. Upper-thigh hemline 30-32cm.',
    material: 'Auxetic origami lattice over a matte base.',
    materialFallback: 'Geometric lattice overlay with crisp ribs.',
    micro: 'AUXETIC ORIGAMI: cells open laterally under tension creating geometric windows; ribs cast crisp micro-shadows with slight edge curl.',
    microFallback: 'Geometric windows with crisp ribs and micro-shadows.',
    hosiery: 'HOSIERY: Black thigh-high stockings with graphite welt. 2-denier T=0.99 with silicone stay-up band.',
  },
  {
    name: '299-elastocaloric-ribbed-satin',
    scene: 'Soft pendant light pools across the marble bar surface.',
  ...
  {
    name: '300-electrohydrodynamic-sheen',
    scene: 'Backlit liquor wall with faint neon spill and candle clusters.',
  ...
  {
    name: '301-phase-separation-lamella-cowl',
    scene: 'Banquette glow and candle clusters reflect in black marble.',
    geometry: 'Microdress with dramatic cowl back and open sides linked by fine straps; ultra-low scoop neckline with a narrow sheer illusion insert to the upper abdomen. Upper-thigh hemline 30-32cm.',
    material: 'Phase-separated lamella satin.',
    materialFallback: 'Satin with alternating gloss/diffuse bands.',
    micro: 'LAMELLAE: alternating gloss and diffuse bands at sub-mm scale create soft interference shimmer without harsh glare.',
    microFallback: 'Soft alternating sheen bands across the satin.',
    hosiery: 'HOSIERY: Black thigh-high stockings with prism welt. 2-denier T=0.99 with silicone stay-up band.',
  },
  {
    name: '302-perovskite-glass-bead-drape',
    scene: 'CityCenter night lights through windows and mirrored columns.',
  ...
  {
    name: '303-nanobubble-lens-hem',
    scene: 'Bronze foot rail reflections on the marble bar edge.',
  ...
  {
    name: '304-acoustic-fiber-resonance',
    scene: 'Mirrored columns and geometric ceiling light grid.',
    geometry: 'Halter microdress with open back to the waist and high side cutouts; low square neckline with an elongated center keyhole to the upper abdomen and sheer mesh backing. Upper-thigh hemline 30-32cm.',
    material: 'Acoustic resonance fibers woven into satin.',
    materialFallback: 'Satin with fine fibers that glint at vibration nodes.',
    micro: 'RESONANT FIBERS: micro-vibration blur on fiber tips; tiny specular pulses align with vibration nodes.',
    microFallback: 'Fibers show tiny vibration glints and faint blur at tips.',
    hosiery: 'HOSIERY: Black thigh-high stockings with cobalt welt. 2-denier T=0.99 with silicone stay-up band.',
  },
  {
    name: '305-ion-conductive-gauze',
    scene: 'Bar garnish station, ice bins, and warm pendant light pools.',
  ...
  {
    name: '306-birefringent-ribbon-lattice',
    scene: 'Pendant lights and banquette glow behind the bar.',
  ...
  {
    name: '307-chiral-microcoil-chain',
    scene: 'CityCenter lights and soft neon reflections across the bar.',
  ...
  {
    name: '308-graphene-aerogel-tulle',
    scene: 'Mirrored columns and ceiling light grid framing the lounge.',
  ...
  {
    name: '309-microlouver-iris-panels',
    scene: 'Bronze foot rail and marble reflections beneath the bar.',
    geometry: 'Microdress with a wide underbust aperture and open back to the waist; straight neckline just below collarbones with an elongated center keyhole to the upper abdomen, backed by sheer mesh. Upper-thigh hemline 30-32cm.',
  ...
  {
    name: '310-thermocapillary-flow-seams',
    scene: 'Backlit liquor wall with candle clusters and soft neon spill.',
...
console.log(`\n=== V26 APEX - Two-pass, multi-turn refinement ===`);

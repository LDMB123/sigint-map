# Vegas Speakeasy Prompt Pack v10 (Deep Micro-Physics + Batch-Learned Adherence Expansion)

Design goal: deeply update all 20 prompts with solver-style per-zone causality constraints, stronger color/scene adherence locks, and denser micro-physics detail based on the latest 20-image diagnostics.

Audit-informed priorities from last full 20 run:
- Hard color-family lock for 07 (absinthe palette drift observed).
- Stronger scene-anchor preservation for 16 (service-bar context drift observed).
- Gaze/edge reinforcement cues for 09 and 10 while keeping non-explicit framing stable.
- Safety-stable but still high-detail phrasing for 15 and 17 (rescue safety pressure observed).
- Rehearsal-scene anchor hardening for 19 to reduce generic-background fallback.
...
V10 BATCH-LEARNING MICRO-PHYSICS + ADHERENCE PROTOCOL (HARD):
...
V10 SAFE VARIANT ADHERENCE + MICRO-PHYSICS PROTOCOL (HARD):

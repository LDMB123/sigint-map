...
V12 FIRST-PRINCIPLES PHYSICS CONTRACT (HARD):
...
- Venue-domain lock (hard fail on drift): keep commercial nightlife context; no bedroom, home, or residential substitutions unless explicitly requested.
...
- Identity-feature lock: preserve reference eye spacing, brow arc, nose bridge, lip shape, jaw contour, and smile asymmetry across pose and light changes.
...
- Safety-compliant edge framing: upscale cocktail-fashion intent only; avoid lingerie-coded or intimate framing cues.
...
V12 SAFE FIRST-PRINCIPLES PHYSICS CONTRACT (HARD):
...
- Venue-domain lock: keep nightlife/commercial context with no residential substitutions.
- Lens-lock gaze certainty: direct camera eye alignment with credible eyelid tension and catchlight placement.
- Identity-feature lock: preserve facial geometry anchors and smile asymmetry from the reference.
- Lens-axis strictness: both irises must remain centered on lens axis (no near-off-camera drift).
- Physics lock: maintain two-piece topology, denier optics, seam relief, and contact-compression causality at 100% inspection.
- Safety-compliant edge framing: keep couture edge through posture, light, and materials while avoiding ambiguity at coverage-critical zones.
...
- Piano identity-gaze lock: preserve reference facial identity under noir contrast and keep both pupils lens-centered with symmetric catchlights.
SCORER-ALIGNED CONSISTENCY LOCK:
- Keep direct lens-locked gaze with believable vergence and eyelid tension in final frame.
- Preserve identity fidelity under mixed practical light; no face drift under pose/exposure shifts.
- Enforce complete wardrobe replacement from reference clothing cues.
...
- Roulette venue lock: prohibit bedroom or domestic cues (bed, nightstand, residential wall art, home furniture).
SCORER-ALIGNED CONSISTENCY LOCK:
- Keep direct lens-locked gaze with believable vergence and eyelid tension in final frame.
- Preserve identity fidelity under mixed practical light; no face drift under pose/exposure shifts.
- Enforce complete wardrobe replacement from reference clothing cues.
...
- Cellar safety-clarity lock: top must read as cocktail couture (not lingerie-coded), with unambiguous underlayer coverage.
SCORER-ALIGNED CONSISTENCY LOCK:
- Keep direct lens-locked gaze with believable vergence and eyelid tension in final frame.
- Preserve identity fidelity under mixed practical light; no face drift under pose/exposure shifts.
- Enforce complete wardrobe replacement from reference clothing cues.
...
- Vault safety-clarity lock: metallic top geometry must keep clear coverage-critical support edges under pose changes.
SCORER-ALIGNED CONSISTENCY LOCK:
- Keep direct lens-locked gaze with believable vergence and eyelid tension in final frame.
- Preserve identity fidelity under mixed practical light; no face drift under pose/exposure shifts.
- Enforce complete wardrobe replacement from reference clothing cues.
...
- Chandelier underlayer lock: preserve clear underlayer readability in all highlights and shadows; no ambiguity at neckline or side seams.
SCORER-ALIGNED CONSISTENCY LOCK:
- Keep direct lens-locked gaze with believable vergence and eyelid tension in final frame.
- Preserve identity fidelity under mixed practical light; no face drift under pose/exposure shifts.
- Enforce complete wardrobe replacement from reference clothing cues.
...
- Service bar gaze-axis lock: enforce strict lens-axis eye contact with no near-off-camera gaze drift.
SCORER-ALIGNED CONSISTENCY LOCK:
- Keep direct lens-locked gaze with believable vergence and eyelid tension in final frame.
- Preserve identity fidelity under mixed practical light; no face drift under pose/exposure shifts.
- Enforce complete wardrobe replacement from reference clothing cues.
...
- Last-call safety-clarity lock: maintain crisp, non-ambiguous garment boundaries in high-key lighting and reflections.
SCORER-ALIGNED CONSISTENCY LOCK:
- Keep direct lens-locked gaze with believable vergence and eyelid tension in final frame.
- Preserve identity fidelity under mixed practical light; no face drift under pose/exposure shifts.
- Enforce complete wardrobe replacement from reference clothing cues.

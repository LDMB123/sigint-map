# Vegas Speakeasy Prompt Pack v9 (Deep Micro-Physics Expansion)

Design goal: deeply update all 20 prompts with solver-style per-zone causality constraints, scorer-aligned gates, and stronger scene-specific physical detail fidelity.

Audit-informed priorities from last full 20 run:
- Edge/gaze reinforcement for 02 and 09.
- Attire replacement + edge enforcement for 12.
- Safety-robust yet high-detail phrasing for 05, 08, 11, 17.
- Preserve non-explicit framing while increasing measurable micro-physics density across all prompts.
...
- Editorial guardrail: provocative but non-explicit, premium nightlife campaign intent only.

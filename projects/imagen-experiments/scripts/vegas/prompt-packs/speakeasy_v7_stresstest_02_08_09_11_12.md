# Vegas Speakeasy v7 Stress Test (Targeted Weak IDs)

Design goal: validate the highest-risk prompts after the micro-physics rewrite before full-batch execution.

...
const OUTPUT_DIR = '/Users/louisherman/nanobanana-output/vegas-refined';
...
const concepts = Array.from({length: 20}, (_, i) => {
  ...
  return {
    name: `Vegas-Refined-${String(i+1).padStart(2, '0')}`,
...
async function main() {
  ...
  console.log('VEGAS REFINED BATCH: 20 Concepts');
  console.log('='.repeat(80));

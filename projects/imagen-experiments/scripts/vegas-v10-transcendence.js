...
CAMERA WAVEFRONT OPTICS: Canon EOS R5 Mark II 45MP stacked BSI-CMOS full-frame 36x24mm. RF 50mm f/1.2L USM wide open. Wavefront aberration described by Zernike polynomials: Z4 defocus varying continuously with depth, Z7+Z8 coma 0.15 waves at field edges creating comet-tail PSF on off-axis neon, Z11 spherical 0.08 waves creating focus shift between marginal and paraxial rays, Z5+Z6 astigmatism 0.05 waves stretching point sources into ellipses at corners. Focus plane at 2.2m subject iris: objects at 2.15m show Z4=0.3 waves defocus (perceptible softening), at 2.0m Z4=1.5 waves (clearly soft), at 1.5m and 3.0m Z4>4 waves (fully defocused colored blobs). Continuous smooth PSF evolution NOT binary sharp-blurry. ISO 3200 Poisson shot noise sigma=sqrt(N) SNR=28dB midtones with chroma noise as red-blue decorrelation in underexposed zones. Shutter 1/125s slight motion blur gesturing hands. 759-point DPAF locked nearest iris. 15-blade aperture: bright neon point sources produce Fraunhofer diffraction starburst with 30 rays (2×15 blades) visible spikes radiating outward, intensity following sinc^2 envelope, strongest on brightest sources weakening with distance. Electronic rolling shutter 8.2ms readout: fast-moving neon signs show 2-3px horizontal skew from top-to-bottom temporal offset. Barrel distortion 0.8%. Hard highlight clipping: sensor well capacity exceeded at bright neon creating pure white with 1-2px magenta fringing from per-channel saturation difference. Bayer CFA demosaicing false color moire at fine repetitive textures. No flash. Crushed blacks below noise floor. Vignetting cos^4 radial 0.7-stop corners.

3D LIGHT TRANSPORT + METAMERISM: Primary tungsten halogen 2800K Planckian blackbody CRI=100 warm, small 3cm capsule near-point-source hard umbral shadows narrow penumbral transition. Secondary neon saturated colored spill inverse-square I=Phi/(4pi*r^2). Tertiary fluorescent 4100K CRI=62 narrow triband phosphor peaks at 435nm+545nm+612nm creating metameric failure: fabric colors that appear identical under tungsten render as DIFFERENT colors under fluorescent due to spectral mismatch between fabric reflectance and illuminant SPD -- warm reds shift toward brown-orange, deep blues toward grey-green under fluorescent zones. CRI degradation visible as desaturation and hue shift in background where fluorescent dominates. 4-stop luminance gradient bar to booths. NO fill -- 5+ stop shadow-side true black. Color interreflection: neon photons bounce from bar surface to underside of chin creating colored fill on shadow-side jaw. Dual-illuminant white balance error: camera auto-WB compromises between 2800K and 4100K resulting in neither correct -- skin retains amber cast under tungsten while same skin shows cyan-green under fluorescent creating visible color boundary on subject where two illuminants overlap. Atmospheric turbulence scintillation: heat from bar lighting creates refractive index gradient dn/dT=-1×10^-4 K^-1 causing subtle shimmer distortion on background objects behind heat sources as micro-lensing from thermal convection cells. Beer-Lambert atmospheric haze tau=0.08/m at 550nm.

SKIN BIO-OPTICAL + FLUORESCENCE: 3-layer epidermis-dermis-hypodermis Monte Carlo SSS. Melanin mu_a=6.6*C_mel*(lambda/500)^(-3.33) C_mel 0.01-0.05. HbO2 peaks 542nm 576nm warm flush cheeks earlobes decolletage. Stratum corneum n=1.55 Fresnel R_0=4.7% gloss component DISTINCT from subsurface warm glow -- both simultaneously as layered effect, grazing Schlick near-total creating bright specular rim over warm SSS beneath. Alcohol vasodilation: 20% dermal perfusion increase creating warmer pinker blotchy asymmetric patches cheeks upper chest neck. Collagen autofluorescence: UV component of neon excites dermal collagen at 340nm re-emitting broad 400nm violet-blue -- visible as faint cool luminous undertone on thin-skin areas (inner wrist, temples, decolletage) under UV-rich light sources only, absent under pure tungsten. Skin microrelief primary furrows 20-100 micron crosshatch non-uniform specular. Sebaceous oil T-zone irregular specular. Vellus hair forearms jawline catching rim light. Perspiration: micro-droplets on upper lip temples acting as individual plano-convex lenslets each creating minuscule inverted real image of brightest light source, plus thin-film interference in droplet meniscus at skin surface creating faint spectral color fringe around droplet perimeter. Marschner hair BSDF: R lobe (surface reflection) creating specular highlight shifted toward root, TT lobe (transmission-transmission) creating broad transmitted glow, TRT lobe (internal reflection) creating secondary highlight -- three distinct highlights visible on dark hair under hard directional tungsten. Corneal Purkinje reflections: 4 reflected images from eye surfaces -- bright P1 from anterior cornea, dimmer P2 from posterior cornea, P3 from anterior lens (inverted, very faint), P4 from posterior lens -- P1 dominant as small bright window-shaped reflection of brightest venue light source. Lip tissue: thin epithelium transmitting hemoglobin creating natural pink, moisture film high-gloss specular, fine vertical furrows. Preserve face bone structure eye color expression exactly.

${fabricPhysics}

${hosieryPhysics}

RAW IMPERFECTIONS: ISO 3200 grain especially shadows. Motion blur fingertips 1/125s. Flyaway hair backlit different focal plane as soft bright streak following Marschner R-lobe scattering. Colored bokeh neon as large soft discs with 15-blade aperture shape visible on brightest. Foreground glass edge refraction blur. Lens flare veiling glare plus 2-3 faint green hexagonal ghosts at mirror-reflected positions through optical center from bright neon. Rolling shutter 2-3px skew on moving neon. Compression creases at hip from sitting. Crumpled napkin condensation ring patron elbow frame edge. Vignetting cos^4 0.7-stop corners. Faint fundus reflection one eye only at slight off-axis angle. Thermochromic micro-response: fabric in direct contact with warm skin shows subtle 2-3nm spectral shift vs same fabric hanging free in cooler air -- visible as barely perceptible color temperature difference between body-contact and free-hanging regions of same garment. Fabric acoustic resonance: deep bass from venue sound system at 40-80Hz excites resonant modes in lightweight free-hanging fabric edges creating 0.5-1mm amplitude micro-flutter visible as slight motion blur at hemline edges and thin strap edges only. No retouching no smoothing no grading -- straight RAW white balance only. Preserve face expression all features identical to original.`;
}

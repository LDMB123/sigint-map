---
name: dmb-almanac-critical-fixes
description: "Critical bug fixes and urgent patches for DMB Almanac"
...
migrated_from: projects/dmb-almanac/app/docs/analysis/uncategorized/CRITICAL_FIXES_GUIDE.md
...
**Location**: `src/lib/components/frontend/StorageQuotaMonitor.svelte`
...
<script>
  ...
  import StorageQuotaMonitor from '$lib/components/frontend/StorageQuotaMonitor.svelte';
  import UpdatePrompt from '$lib/components/frontend/UpdatePrompt.svelte';

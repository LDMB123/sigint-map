---
name: dmb-almanac-component-update
version: 1.0.0
description: Quick reference for updating each of the 5 visualization components to use the shared `d3-utils.ts` module.
...
migrated_from: projects/dmb-almanac/app/docs/analysis/misc/COMPONENT_UPDATE_REFERENCE.md

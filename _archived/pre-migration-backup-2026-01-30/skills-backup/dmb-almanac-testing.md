...
migrated_from: projects/dmb-almanac/app/docs/analysis/uncategorized/TESTING_GUIDE.md
...
**When to delegate:**
- Parallel test execution → `/parallel-audit` for running tests in parallel
- Coverage analysis → `/parallel-audit` for comprehensive coverage
- E2E testing → `/offline-e2e-test-harness` for offline scenarios

**Works well with:**
- `/perf-audit` - Performance testing
- `/parallel-security` - Security testing
- `/visual-regression-check` - Visual testing

---
name: dmb-almanac-install-banner
version: 1.0.0
...
### Created
- `/apps/web/src/components/frontend/InstallBanner.tsx` - The new install component
...
Modified:
~/Documents/dmbalmanac-v2/apps/web/src/app/(main)/page.tsx
  - Line 4: Added import

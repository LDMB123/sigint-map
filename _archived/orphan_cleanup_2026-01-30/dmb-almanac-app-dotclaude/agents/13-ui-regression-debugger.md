...
## Mission
Detect and diagnose visual and interaction regressions caused by JS→HTML/CSS migrations. Provide clear reproduction steps, DOM diffs, and fix recommendations.
